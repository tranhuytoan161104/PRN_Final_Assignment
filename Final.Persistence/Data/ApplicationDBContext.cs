    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
                new Product { Id = 1, CategoryId = 1, BrandId = 1, Name = "Intel Core i9-14900K", Price = 15500000m, Description = "Vi xử lý đầu bảng cho gaming và sáng tạo nội dung, 24 nhân 32 luồng, tốc độ tối đa 6.0 GHz.", StockQuantity = 50, CreatedAt = DateTime.SpecifyKind(new DateTime(2024, 1, 10), DateTimeKind.Utc), AddAt = DateTime.SpecifyKind(new DateTime(2025, 1, 1), DateTimeKind.Utc) },
                new Product { Id = 2, CategoryId = 1, BrandId = 1, Name = "Intel Core i7-14700K", Price = 11200000m, Description = "Lựa chọn tuyệt vời cho gaming hiệu năng cao, 20 nhân 28 luồng.", StockQuantity = 80, CreatedAt = DateTime.SpecifyKind(new DateTime(2024, 1, 10), DateTimeKind.Utc), AddAt = DateTime.SpecifyKind(new DateTime(2025, 1, 1), DateTimeKind.Utc) },
                new Product { Id = 3, CategoryId = 1, BrandId = 2, Name = "AMD Ryzen 9 7950X3D", Price = 14800000m, Description = "Vua gaming với công nghệ 3D V-Cache, 16 nhân 32 luồng.", StockQuantity = 45, CreatedAt = DateTime.SpecifyKind(new DateTime(2024, 2, 5), DateTimeKind.Utc), AddAt = DateTime.SpecifyKind(new DateTime(2025, 1, 1), DateTimeKind.Utc) },
                new Product { Id = 4, CategoryId = 1, BrandId = 2, Name = "AMD Ryzen 7 7800X3D", Price = 9800000m, Description = "Hiệu năng gaming thuần túy tốt nhất phân khúc nhờ 3D V-Cache, 8 nhân 16 luồng.", StockQuantity = 120, CreatedAt = DateTime.SpecifyKind(new DateTime(2024, 2, 5), DateTimeKind.Utc), AddAt = DateTime.SpecifyKind(new DateTime(2025, 1, 1), DateTimeKind.Utc) },

                new Product { Id = 5, CategoryId = 2, BrandId = 3, Name = "NVIDIA GeForce RTX 4090", Price = 45000000m, Description = "Sức mạnh tối thượng cho gaming 4K và các tác vụ AI, Ray Tracing đỉnh cao.", StockQuantity = 25, CreatedAt = DateTime.SpecifyKind(new DateTime(2024, 1, 15), DateTimeKind.Utc), AddAt = DateTime.SpecifyKind(new DateTime(2025, 1, 1), DateTimeKind.Utc) },
                new Product { Id = 6, CategoryId = 2, BrandId = 3, Name = "NVIDIA GeForce RTX 4080 Super", Price = 31000000m, Description = "Hiệu năng vượt trội cho gaming 1440p và 4K, phiên bản nâng cấp của RTX 4080.", StockQuantity = 40, CreatedAt = DateTime.SpecifyKind(new DateTime(2024, 2, 20), DateTimeKind.Utc), AddAt = DateTime.SpecifyKind(new DateTime(2025, 1, 1), DateTimeKind.Utc) },
                new Product { Id = 7, CategoryId = 2, BrandId = 2, Name = "AMD Radeon RX 7900 XTX", Price = 28500000m, Description = "Card đồ họa đầu bảng của AMD, đối thủ cạnh tranh trực tiếp với RTX 4080.", StockQuantity = 35, CreatedAt = DateTime.SpecifyKind(new DateTime(2024, 1, 25), DateTimeKind.Utc), AddAt = DateTime.SpecifyKind(new DateTime(2025, 1, 1), DateTimeKind.Utc) },
                new Product { Id = 8, CategoryId = 2, BrandId = 2, Name = "AMD Radeon RX 7800 XT", Price = 15000000m, Description = "Lựa chọn p/p tốt nhất cho gaming 1440p.", StockQuantity = 90, CreatedAt = DateTime.SpecifyKind(new DateTime(2024, 3, 1), DateTimeKind.Utc), AddAt = DateTime.SpecifyKind(new DateTime(2025, 1, 1), DateTimeKind.Utc) },

                new Product { Id = 9, CategoryId = 3, BrandId = 4, Name = "Corsair Vengeance DDR5 32GB (2x16GB) 6000MHz", Price = 3200000m, Description = "Kit RAM DDR5 hiệu năng cao, tản nhiệt nhôm, tương thích tốt với Intel XMP và AMD EXPO.", StockQuantity = 150, CreatedAt = DateTime.SpecifyKind(new DateTime(2024, 1, 5), DateTimeKind.Utc), AddAt = DateTime.SpecifyKind(new DateTime(2025, 1, 1), DateTimeKind.Utc) },
                new Product { Id = 10, CategoryId = 3, BrandId = 8, Name = "G.Skill Trident Z5 RGB DDR5 32GB (2x16GB) 6400MHz", Price = 3800000m, Description = "Thiết kế đẹp mắt với LED RGB, tốc độ bus cao dành cho người dùng chuyên nghiệp và game thủ.", StockQuantity = 110, CreatedAt = DateTime.SpecifyKind(new DateTime(2024, 2, 12), DateTimeKind.Utc), AddAt = DateTime.SpecifyKind(new DateTime(2025, 1, 1), DateTimeKind.Utc) },

                new Product { Id = 13, CategoryId = 4, BrandId = 6, Name = "Samsung 990 Pro NVMe M.2 SSD 2TB", Price = 4500000m, Description = "Ổ cứng NVMe Gen4 nhanh nhất thị trường, lý tưởng cho hệ điều hành, game và ứng dụng nặng.", StockQuantity = 70, CreatedAt = DateTime.SpecifyKind(new DateTime(2024, 2, 18), DateTimeKind.Utc), AddAt = DateTime.SpecifyKind(new DateTime(2025, 1, 1), DateTimeKind.Utc) },
                new Product { Id = 14, CategoryId = 4, BrandId = 7, Name = "WD Black SN850X NVMe M.2 SSD 2TB", Price = 4200000m, Description = "Tốc độ đọc ghi cực nhanh, lựa chọn hàng đầu của game thủ.", StockQuantity = 85, CreatedAt = DateTime.SpecifyKind(new DateTime(2024, 3, 3), DateTimeKind.Utc), AddAt = DateTime.SpecifyKind(new DateTime(2025, 1, 1), DateTimeKind.Utc) }
            );
            #endregion
